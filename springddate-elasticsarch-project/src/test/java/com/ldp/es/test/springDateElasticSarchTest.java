package com.ldp.es.test;

import com.ldp.es.bean.Article;
import com.ldp.es.repository.ArticleRepository;
...
public class springDateElasticSarchTest {
    ...
    public void testNativeSearchQuery() throws Exception {
        ...
        NativeSearchQuery query = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.queryStringQuery("国家主席习近平").defaultField("title"))
